...
let createRequestModuleName resource = sprintf "Get%sRequest" resource.Name
let createMemberName resource = sprintf "Get%s" resource.Name
let createApiUrl resource = sprintf "/api/v1/%s" resource.Name
...
let buildResourceRequest resource = 
    ...
    let resourceUrl = createApiUrl resource
